...
$result = $obj->viewAllBinGarbageStatus(); //To get all bins info
...
<!--                                            <a href="../controller/bincontroller.php?binAllocationID=--><?php //echo $row['binAllocationID']; ?><!--&status=--><?php //echo $label; ?><!--&changedBy=--><?php //echo $fname; ?><!--&cusID=--><?php //echo $row['cusID']; ?><!--">-->
<!--                                                <button type="button" class="--><?php //echo $class; ?><!--">-->
<!--                                                    --><?php //echo $label; ?><!--</button></a>-->

                                            <!-- <a href="../controller/bincontroller.php?binAllocationID=<?php /*echo $row['binAllocationID']; */?>&status=<?php /*echo $label; */?>&changedBy=<?php /*echo $fname; */?>&cusID=<?php /*echo $row['cusID']; */?>">
                                                <button type="button" class="<?php /*echo $class; */?>" onclick="return confMessage('<?php /*echo $label; */?>')" data-toggle="modal" data-target="#exampleModalCenter" data-dismiss="modal">
                                                    <?php /*echo $label; */?></button></a>-->
