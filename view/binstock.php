                            ...
                            <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                ...
                                while ($row = $result->fetch_array()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../view/viewbinstock.php?proID=<?php echo $row['proID']; ?>&sizeID=<?php echo $row['sizeID']; ?>&colorID=<?php echo $row['colorID']; ?>&status=View"> <button type="button" class="btn btn-success"> View</button>
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
