            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                ...
                                while ($rowc = $resultc->fetch_array()) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><a href="eshopdetail.php?proID=<?php echo $rowc['proID']; ?>">
                                                <img alt="" width="175" src="../images/proImages/<?php echo $ro['proImageName']; ?>"></a></td>
                                        <td><?php echo $rowc['proName']; ?>
                                            <br/>
                        ...
                        <hr>
                        <p class="right">
<!--                            <strong>Sub-Total</strong>:	Gp --><?php //echo $tot; ?><!--<br>-->
...
<!--                            <strong>VAT +(11%)</strong>: Rs --><?php //echo $vat; ?><!--<br>-->
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="eshop.php" class="btn btn-success">
