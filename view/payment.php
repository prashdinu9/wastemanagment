...
include '../model/paymentmodel.php'; //To call payment model

$ob = new dbconnection();
$con = $ob->connection();
$obj = new payment(); //To create an object using payment class
$result = $obj->viewAllPayment(); //To get all payment info
