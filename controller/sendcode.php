...
try {
    ...
    //Content
    $mail->isHTML(true);
    $mail->Subject = 'Bin Activation!';
    $mail->Body    = 'Hello Prashani, Thank you for registering. please login to the system and code is '. $activationCode;
